...
exports.toBase64 = function toBase64(path) {
  try {
    ...
    console.error(exports.stylize('Unable to locate ', exports.stylize(path.replace(process.cwd(), ''), 'bold'), 'yellow'));
    console.error('  ', exports.stylize('Will leave the url declaration as is.', 'green'));
  }
};
...
exports.toUTF = function toUTF(path) {
  try {
    ...
    console.error(exports.stylize('Unable to locate ', exports.stylize(path.replace(process.cwd(), ''), 'bold'), 'red'));
    console.error(exports.stylize('Cannot proceed with a wrong list of files.', 'red'));
    process.exit(1);
  }
};
